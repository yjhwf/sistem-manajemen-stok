...
{{-- TABS --}}
<div class="tab-nav">
    <a href="/transaksi" class="active">Barang Masuk</a>
    <a href="/transaksi/keluar">Barang Keluar</a>
</div>

{{-- HEADER --}}
<div class="section-head">
    <h5>
        <i class="bi bi-box-arrow-in-down me-1" style="color:#16a34a;"></i>
    ...
    <div class="d-flex gap-2 align-items-center">
        ...
        <a href="/transaksi/create" class="btn btn-success d-flex align-items-center gap-1">
    ...
    <table class="table">
        ...
        @forelse($transaksis as $trx)
            <tr>
                ...
                <td>{{ $trx->exp_date ? \Carbon\Carbon::parse($trx->exp_date)->format('d M Y') : '-' }}</td>
